function app_user_application(app,id,nombre,url,evento){
    global_app_user_application = false
    var variables
    //alert(evento)
    switch (evento) 
    {  
   ...
   //alert (id)
    ...
    {  
      ...
      case 2: variables = add_aplicaciones_permisos(id); break; // act bbdd
      default:   alert ('no hubo accion de la bbdd');
    }
    variables =  variables +'&evento='+evento
    //alert (variables)
   // alert (url)
   if(global_app_user_application == false)
   {
...
function add_aplicaciones_permisos(id)
{
