...
<div class="portlet light bordered">
	...
	<?php    
		...
		{ 
			...
			$sql = "DELETE FROM access WHERE id_usuario = ".$id." ;"  ;
			...
			foreach($cursor as $v)
			{
				if(!empty($v))
				{
					$sql= $sql." INSERT INTO access(id_usuario,id_aplicacion) VALUES (".$id.",".$v.") ;";
				}
			...
			echo "<a href=\"#\" onclick=\"ventana_principal('11','../APP/APP_ADM_USER_APPLICATION/index.php')\" class=\"btn default\">
					<span>Volver</span>
				  </a>";
		}
		else
