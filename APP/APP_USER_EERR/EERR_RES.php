...
<html>
	...
	<body> 
		...
		?>
		<div class="col-md-12"> 
			<h3>Datos de B&uacute;squeda</h3> 		
					...
					echo '<td>';
						...
						foreach ($agrupadores as $a){   
							if ($R1[0] == $a[1] && $e[0] == $a[2])
							{
								...
								//echo '<a '.$color.' href="DETAILS_SEARCH.php?agno='.$agno.'&scenario='.$e[0].'&ctacble='.$R1[0].'&nivel='.$R1[6].'" rel="modal:open">'; 
							?>
								...
								echo '<td>'; 
									foreach ($agrupadores as $a){   
										if ($R2[0] == $a[1] && $e[0] == $a[2])
										{
											...
											// echo '<a '.$color.' href="DETAILS_SEARCH.php?agno='.$agno.'&scenario='.$e[0].'&ctacble='.$R2[0].'&nivel='.$R2[6].'" rel="modal:open">'; 
											?>
									...
									echo '<td>'; 
										foreach ($agrupadores as $a){   
											if ($R3[0] == $a[1] && $e[0] == $a[2])
											{
												...
												//echo '<a '.$color.' href="DETAILS_SEARCH.php?agno='.$agno.'&scenario='.$e[0].'&ctacble='.$R3[0].'&nivel='.$R3[6].'" rel="modal:open">'; 
												?>
											...
											echo '<td>'; 
												foreach ($agrupadores as $a){   
													if ($R4[0] == $a[1] && $e[0] == $a[2])
													{
														...
														// echo '<a '.$color.' href="DETAILS_SEARCH.php?agno='.$agno.'&scenario='.$e[0].'&ctacble='.$R4[0].'&nivel='.$R4[6].'" rel="modal:open">'; 
														?>
													...
													echo '<td>'; 
														foreach ($agrupadores as $a){   
															if ($R5[0] == $a[1] && $e[0] == $a[2])
															{
																...
																//echo '<a '.$color.' href="DETAILS_SEARCH.php?agno='.$agno.'&scenario='.$e[0].'&ctacble='.$R5[0].'&nivel='.$R5[6].'" rel="modal:open">'; 
																?>
															...
															echo '<td>'; 
																foreach ($agrupadores as $a){   
																	if ($R6[0] == $a[1] && $e[0] == $a[2])
																	{
																		...
																		// echo '<a '.$color.' href="DETAILS_SEARCH.php?agno='.$agno.'&scenario='.$e[0].'&ctacble='.$R6[0].'&nivel='.$R6[6].'" rel="modal:open">'; 
																		?>
																	...
																	echo '<td>'; 
																		foreach ($agrupadores as $a){   
																			if ($R7[0] == $a[1] && $e[0] == $a[2])
																			{
																				...
																				// echo '<a '.$color.' href="DETAILS_SEARCH.php?agno='.$agno.'&scenario='.$e[0].'&ctacble='.$R7[0].'&nivel='.$R7[6].'" rel="modal:open">'; 
																				?>
																				...
																				echo '<td>'; 
																					foreach ($ctacbles as $c){ 
																						if (trim($R8[5]) == trim($c[0]) && $e[0] == $c[1])
																						{
																							...
																							//echo '<a '.$color.' href="DETAILS_SEARCH.php?agno='.$agno.'&scenario='.$e[0].'&ctacble='.$R8[0].'&nivel='.$R8[6].'" rel="modal:open">'; 
																						?>
