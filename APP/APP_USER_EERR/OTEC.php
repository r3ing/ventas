...
<html>
	...
	<body> 
		...
		<?php  
			...
			$ctacbles		=	get_total_ctacble_otec($data);
			$escenarios		= 	get_escenarios($data);  	
			$jer_ctacble	= 	get_jerarquia_ctacble($data);
			$agrupadores	= 	get_total_agrupadores_otec($data);
					...
					echo '<td>';
						...
						foreach ($agrupadores as $a){   
							if ($R1[0] == $a[1] && $e[0] == $a[2])
							{
								...
								//echo '<a '.$color.' href="DETAILS_OTEC.php?agno='.$agno.'&scenario='.$e[0].'&ctacble='.$R1[0].'&nivel='.$R1[6].'" rel="modal:open">'; 
							?>
								<a href="DETAILS_OTEC.php?agno=<?php echo $agno; ?>&scenario=<?php echo $e[0]; ?>&ctacble=<?php echo $R1[0]; ?>&nivel=<?php echo $R1[6]; ?>" target="_blank" onClick="window.open(this.href, this.target, 'width=1800,height=750'); return false;" <?php echo $color; ?>> 
							<?php 
								...
								echo '<td>'; 
									foreach ($agrupadores as $a){   
										if ($R2[0] == $a[1] && $e[0] == $a[2])
										{
											...
											// echo '<a '.$color.' href="DETAILS_OTEC.php?agno='.$agno.'&scenario='.$e[0].'&ctacble='.$R2[0].'&nivel='.$R2[6].'" rel="modal:open">'; 
											?>
												<a href="DETAILS_OTEC.php?agno=<?php echo $agno; ?>&scenario=<?php echo $e[0]; ?>&ctacble=<?php echo $R2[0]; ?>&nivel=<?php echo $R2[6]; ?>" target="_blank" onClick="window.open(this.href, this.target, 'width=1800,height=750'); return false;" <?php echo $color; ?>> 
											<?php 
												if ($e[6] == 'Regular')   	echo number_format($a[3], 0, ".", "."); 
												if ($e[6] == 'Negrita')		echo '<b>'.number_format($a[3], 0, ".", ".").'</b>'; 
												if ($e[6] == 'Cursiva')		echo '<i>'.number_format($a[3], 0, ".", ".").'</i>'; 
									...
									echo '<td>'; 
										foreach ($agrupadores as $a){   
											if ($R3[0] == $a[1] && $e[0] == $a[2])
											{
												...
												//echo '<a '.$color.' href="DETAILS_OTEC.php?agno='.$agno.'&scenario='.$e[0].'&ctacble='.$R3[0].'&nivel='.$R3[6].'" rel="modal:open">'; 
												?>
													<a href="DETAILS_OTEC.php?agno=<?php echo $agno; ?>&scenario=<?php echo $e[0]; ?>&ctacble=<?php echo $R3[0]; ?>&nivel=<?php echo $R3[6]; ?>" target="_blank" onClick="window.open(this.href, this.target, 'width=1800,height=750'); return false;" <?php echo $color; ?>> 
												<?php 
													if ($e[6] == 'Regular')   	echo number_format($a[3], 0, ".", "."); 
													if ($e[6] == 'Negrita')		echo '<b>'.number_format($a[3], 0, ".", ".").'</b>'; 
													if ($e[6] == 'Cursiva')		echo '<i>'.number_format($a[3], 0, ".", ".").'</i>'; 
											...
											echo '<td>'; 
												foreach ($agrupadores as $a){   
													if ($R4[0] == $a[1] && $e[0] == $a[2])
													{
														...
														// echo '<a '.$color.' href="DETAILS_OTEC.php?agno='.$agno.'&scenario='.$e[0].'&ctacble='.$R4[0].'&nivel='.$R4[6].'" rel="modal:open">'; 
														?>
															<a href="DETAILS_OTEC.php?agno=<?php echo $agno; ?>&scenario=<?php echo $e[0]; ?>&ctacble=<?php echo $R4[0]; ?>&nivel=<?php echo $R4[6]; ?>" target="_blank" onClick="window.open(this.href, this.target, 'width=1800,height=750'); return false;" <?php echo $color; ?>> 
														<?php 
															if ($e[6] == 'Regular')   	echo number_format($a[3], 0, ".", "."); 
															if ($e[6] == 'Negrita')		echo '<b>'.number_format($a[3], 0, ".", ".").'</b>'; 
															if ($e[6] == 'Cursiva')		echo '<i>'.number_format($a[3], 0, ".", ".").'</i>'; 
													...
													echo '<td>'; 
														foreach ($agrupadores as $a){   
															if ($R5[0] == $a[1] && $e[0] == $a[2])
															{
																...
																//echo '<a '.$color.' href="DETAILS_OTEC.php?agno='.$agno.'&scenario='.$e[0].'&ctacble='.$R5[0].'&nivel='.$R5[6].'" rel="modal:open">'; 
																?>
																	<a href="DETAILS_OTEC.php?agno=<?php echo $agno; ?>&scenario=<?php echo $e[0]; ?>&ctacble=<?php echo $R5[0]; ?>&nivel=<?php echo $R5[6]; ?>" target="_blank" onClick="window.open(this.href, this.target, 'width=1800,height=750'); return false;" <?php echo $color; ?>> 
																<?php 
																	if ($e[6] == 'Regular')   	echo number_format($a[3], 0, ".", "."); 
																	if ($e[6] == 'Negrita')		echo '<b>'.number_format($a[3], 0, ".", ".").'</b>'; 
																	if ($e[6] == 'Cursiva')		echo '<i>'.number_format($a[3], 0, ".", ".").'</i>'; 
															...
															echo '<td>'; 
																foreach ($agrupadores as $a){   
																	if ($R6[0] == $a[1] && $e[0] == $a[2])
																	{
																		...
																		// echo '<a '.$color.' href="DETAILS_OTEC.php?agno='.$agno.'&scenario='.$e[0].'&ctacble='.$R6[0].'&nivel='.$R6[6].'" rel="modal:open">'; 
																		?>
																			<a href="DETAILS_OTEC.php?agno=<?php echo $agno; ?>&scenario=<?php echo $e[0]; ?>&ctacble=<?php echo $R6[0]; ?>&nivel=<?php echo $R6[6]; ?>" target="_blank" onClick="window.open(this.href, this.target, 'width=1800,height=750'); return false;" <?php echo $color; ?>> 
																		<?php 
																			if ($e[6] == 'Regular')   	echo number_format($a[3], 0, ".", "."); 
																			if ($e[6] == 'Negrita')		echo '<b>'.number_format($a[3], 0, ".", ".").'</b>'; 
																			if ($e[6] == 'Cursiva')		echo '<i>'.number_format($a[3], 0, ".", ".").'</i>'; 
																	...
																	echo '<td>'; 
																		foreach ($agrupadores as $a){   
																			if ($R7[0] == $a[1] && $e[0] == $a[2])
																			{
																				...
																				// echo '<a '.$color.' href="DETAILS_OTEC.php?agno='.$agno.'&scenario='.$e[0].'&ctacble='.$R7[0].'&nivel='.$R7[6].'" rel="modal:open">'; 
																				?>
																					<a href="DETAILS_OTEC.php?agno=<?php echo $agno; ?>&scenario=<?php echo $e[0]; ?>&ctacble=<?php echo $R7[0]; ?>&nivel=<?php echo $R7[6]; ?>" target="_blank" onClick="window.open(this.href, this.target, 'width=1800,height=750'); return false;" <?php echo $color; ?>> 
																				<?php 
																					if ($e[6] == 'Regular')   	echo number_format($a[3], 0, ".", "."); 
																					if ($e[6] == 'Negrita')		echo '<b>'.number_format($a[3], 0, ".", ".").'</b>'; 
																					if ($e[6] == 'Cursiva')		echo '<i>'.number_format($a[3], 0, ".", ".").'</i>'; 
																				...
																				echo '<td>'; 
																					foreach ($ctacbles as $c){ 
																						if (trim($R8[5]) == trim($c[0]) && $e[0] == $c[1])
																						{
																							...
																							//echo '<a '.$color.' href="DETAILS_OTEC.php?agno='.$agno.'&scenario='.$e[0].'&ctacble='.$R8[0].'&nivel='.$R8[6].'" rel="modal:open">'; 
																						?>
																							<a href="DETAILS_OTEC.php?agno=<?php echo $agno; ?>&scenario=<?php echo $e[0]; ?>&ctacble=<?php echo $R8[0]; ?>&nivel=<?php echo $R8[6]; ?>" target="_blank" onClick="window.open(this.href, this.target, 'width=1800,height=750'); return false;" <?php echo $color; ?>> 
																						<?php
