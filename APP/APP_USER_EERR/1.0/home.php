						...
						<div class="portlet-body">
							<div class="tabbable tabbable-tabdrop">
								<ul class="nav nav-tabs">
									<li class="active">
										<a href="#tab1" data-toggle="tab">Estado de Resultado</a>
									</li>
									<li>
										<a href="#tab2" data-toggle="tab">B&uacute;squeda Avanzada</a>
									</li> 
									<?php 
										if ($vari[6] == 3 || $vari[6] == 2)
										{
									?>
									<li>
										<a href="#tab3" data-toggle="tab">Alertas <i class="fa fa-warning" style="color:#FF9900;"></i></a> 
									</li>
									<?php } ?>
								</ul>
								<div class="tab-content">
									<div class="tab-pane active" id="tab1">
										...
										<p><iframe src="../APP_USER_PPTO_EERR_WEB/EERR.php" width="100%" height="1000" frameborder="0"></iframe></p>
									</div>
									<div class="tab-pane" id="tab2"> 
										<p><iframe src="../APP_USER_PPTO_EERR_WEB/FORM.php" width="100%" height="1000" frameborder="0"></iframe></p>
									</div> 
									<?php 
										if ($vari[6] == 3 || $vari[6] == 2)
										{
									...
									<div class="tab-pane" id="tab3">
										<p> 
										<iframe src="http://192.168.51.128/ReportServer/Pages/ReportViewer.aspx?http%3a%2f%2f192.168.51.128%2fReportServer%2fReportGec%2fReportsIp%2fIPCHILE_EERR_ALERTA_PENDIENTES_GP.rdl&rs:Command=Render" width="100%" height="770" frameborder="0"></iframe>
										</p>
									</div>
									<?php } ?>
								</div>
