								...
								<div class="portlet-body">
									<table class="table table-striped table-bordered table-hover" id="sample_1" style="font-size:11px;">
										...
										<?php 
											include ("../../../../lib/adodb/adodb.inc.php");
											include('../../MASTER/config/conect.php');
											$SQL_PIVOT = "EXEC EERR_TOTAL_CONSOLIDADO_PIVOT_OTEC ".$agno.", ".$scenario.", '".$cuenta."', ".$nivel.", ".$id_usuario."  "; 
										...
										?>
											<tr style="color:#000000;"> 		
												...
												<?php 
													...
													if ($row[9] < 0)	$C1 = $RED;		else if ($row[9] >= 0)	$C1 = $BLACK;													
													if ($row[10] < 0)	$C2 = $RED; 	else if ($row[10] >= 0)	$C2 = $BLACK;													
													if ($row[11] < 0)	$C3 = $RED; 	else if ($row[11] >= 0)	$C3 = $BLACK;													
													if ($row[12] < 0)	$C4 = $RED; 	else if ($row[12] >= 0)	$C4 = $BLACK;													
													if ($row[13] < 0)	$C5 = $RED; 	else if ($row[13] >= 0)	$C5 = $BLACK;													
													if ($row[14] < 0)	$C6 = $RED; 	else if ($row[14] >= 0)	$C6 = $BLACK;													
													if ($row[15] < 0)	$C7 = $RED; 	else if ($row[15] >= 0)	$C7 = $BLACK;													
													if ($row[16] < 0)	$C8 = $RED; 	else if ($row[16] >= 0)	$C8 = $BLACK;													
													if ($row[17] < 0)	$C9 = $RED; 	else if ($row[17] >= 0)	$C9 = $BLACK;													
													if ($row[18] < 0)	$C10 = $RED; 	else if ($row[18] >= 0)	$C10 = $BLACK;													
													if ($row[19] < 0)	$C11 = $RED; 	else if ($row[19] >= 0)	$C11 = $BLACK;													
													if ($row[20] < 0)	$C12 = $RED; 	else if ($row[20] >= 0)	$C12 = $BLACK;
												?>												
